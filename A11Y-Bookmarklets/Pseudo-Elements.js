...
function showDetailsAdjacentToRespectedElement(details, element) {
	...
	let result = "Psuedo-Element: " + details[0] + "; Inserted Using: " + details[1] + "; Psuedo-Element Forground Color: " + details[2];
	p.innerText = result;
	...
	for (let element of elements) {
		...
		if (window.getComputedStyle(element, null).display == "none") {
			...
			if (computedStyleBefore.content !== "none") {
				...
				showDetailsAdjacentToRespectedElement(details, element);
				count++;
			}
